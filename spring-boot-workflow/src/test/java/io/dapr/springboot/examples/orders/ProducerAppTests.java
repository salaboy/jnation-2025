...
import io.dapr.springboot.examples.orders.workflow.ShipOrderActivity;
import io.dapr.springboot.examples.orders.workflow.OrderProcessingWorkflow;
import io.dapr.springboot.examples.orders.workflow.TrackOrderActivity;
...
@SpringBootTest(classes = {TestProducerApplication.class, DaprTestContainersConfig.class,
        DaprAutoConfiguration.class, OrderProcessingWorkflow.class, ShipOrderActivity.class,
        TrackOrderActivity.class, OrdersStore.class},
...
class ProducerAppTests {
  ...
  void testCustomersWorkflows() throws InterruptedException, IOException {
    ...
    /*wait().atMost(Duration.ofSeconds(15))
            .until(ordersStore.getCustomers()::size, equalTo(1));
